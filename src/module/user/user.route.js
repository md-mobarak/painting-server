...
router.get("/users/:id", user_controller_1.userController.userSingleGetController);
router.patch("/users/:id", user_controller_1.userController.userUpdateController);
router.patch("/users/role/:id", auth_1.default, user_controller_1.userController.userRoleUpdateContorller);
